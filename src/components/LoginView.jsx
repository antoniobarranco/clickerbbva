  ...
  return (
    ...
    <>
      ...
      <div className="d-grid gap-2 col-6  my-5 mx-auto">
        ...
        <form onSubmit={handlePlay} data-testid="FormLogin">
          ...
          <div className="input-group mb-3">
            ...
            <button className="btn btn-primary" type="submit" id="button-submit" data-testid="ButtonLogin"><i className="bi bi-joystick"></i> Let&apos;s Play</button>
          </div>
        ...
        <button type="button" className="btn btn-primary btn-lg" onClick={rankingHandle} data-testid="ButtonRankings"><i className="bi bi-bar-chart-line-fill"></i> Rankings</button>
